...
**언어 : 답변 본문, 도구 사이 중간 안내, 생각(thinking) 표시까지 모두 한국어로 쓴다.** (2026-09-14 사용자 지시)
코드·명령·로그 원문·파일명은 원문 그대로 둔다.
...
- 로직1 = **124 입고 / 126 출고** (2026-08-24 현장기준으로 정정 — 표기 뒤집힘 주의), 로직2 = 130 입고 / 129 출고, 로직3 = 122 겸용
