...
rows = [
 ...
 ['4', '백업 파일', 'LGLS_MCS_IO_20260907_clean.bak', 'DB_BACKUP 폴더. 시험 데이터를 비운 배포용 정리본(약 4.6MB). 백업 안의 DB 이름은 LGLS_MCS_IO_DEPLOY 이므로 복원 시 대상 이름을 LGLS_MCS_IO 로 지정한다'],
 ['4', '백업 파일', 'LGLS_MCS_IO_20260902.bak', 'DB_BACKUP 폴더. 운전 이력까지 포함한 전체 백업(약 611MB). 이력이 필요할 때만 쓴다'],
