...
tb(s, 7.15, 1.62, 5.7, 0.32, '→ 시간 기반 자동 완료 폐기 (체류 복구 09-17, 환경설정 옵션 09-21)', 10.5, True, AMBER)
...
box(s, 0.7, 4.28, 12.15, 0.95,
    [('설비 에러 해제는 운전 화면의 기능이 아니다', 11.5, True, NAVY),
     ...
     ('2026-09-21 : 경과시간으로 완료를 추정하던 마지막 경로([환경설정] 시간 기반 자동 처리)도 제거했다.', 10.5, False, GRAY)],
