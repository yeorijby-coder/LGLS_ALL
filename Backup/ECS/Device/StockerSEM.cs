...
namespace HECS.Device
{
    /// <summary>
    /// BIZ 로직의 기본 객체.
    /// STOCKER를 대표하는 객체로, 하부의 객체(SUBSYSTEM)들을 생성,관리하고
    /// 하부객체들 간의 로직 및 상위 시스템(MCS)과의 데이터를 송,수신
    /// 처리하는 객체.
    /// </summary>
    [Serializable]
    public partial class StockerSEM : StorageDevice
    {
        /// <summary>
        /// CLASS 명
        /// </summary>
        private const string CLASS = "StokerSEM";
        ...
        /// 객체 생성자
        /// </summary>
        public StockerSEM(string stockerId)
            : base(stockerId)
        {
        }
        #endregion
...
//2009. 04.21 윤선화 주석처리 장비는 EQUIPMENT,SUBSYSTEM으로 통일
            ...
            {
                Log.log(5, METHOD, "error", Category.ERROR, "", "RACKMASTER", "sql error \n [" + tSql + "\n]" + ex.Message.ToString());
            }
        }
        ...
        void StockerSEM_ObservableLogEvent(object sender, ObservableStatisticsCollectorData collectionData)
        {
            try
            {
