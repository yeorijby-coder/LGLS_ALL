...
{
    [Serializable]
    public class RgvSEM : TransportDevice
    {
        /// CLASS 명
        /// </summary>
        private const string CLASS = "RgvSEM";
        ...
        /// 객체 생성자
        /// </summary>
        public RgvSEM(string stockerId)
            : base(stockerId)
        {
        }
        #endregion
...
//2009. 04.21 윤선화 주석처리 장비는 EQUIPMENT,SUBSYSTEM으로 통일
                ...
                //if (reader.Read())
                //{
                //    Log.log(5, METHOD, "debug", Category.DEBUG, "", "RgvSEM", this.iD + "already Exist");
...
//2009. 04.21 윤선화 주석처리 장비는 EQUIPMENT,SUBSYSTEM으로 통일
                ...
                //else
                //{
                //    Log.log(5, METHOD, "debug", Category.DEBUG, "", "RgvSEM", this.iD + "doesnot exist");
                //}
            ...
            catch (SqlException ex)
            {
                ...
                Log.log(5, METHOD, "error", Category.ERROR, "", "RgvSEM", "sql error \n " + ex.Message.ToString());
                throw ex;
            }
            catch (Exception ex)
            {
                StatisticsCollector.TriggerOccured(
                                                  ...
                                                  RunTimeExceptionStatisticsCollectorData.TRIGGER_CORE_EXCEPTION,
                                                  new RunTimeExceptionStatisticsCollectorData("StockerSem", "Load", "Loading Error", ex.ToString(), ex.StackTrace.ToString()));
                Log.log(5, METHOD, "error", Category.ERROR, "", "RgvSEM", "error \n " + ex.Message.ToString());
                throw ex;
            }
            finally
            {
