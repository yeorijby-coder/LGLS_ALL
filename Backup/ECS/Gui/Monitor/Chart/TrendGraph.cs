...
namespace HECS.Gui.Monitor.Chart
{
    public class TrendGraph : Control
    {
        // ===================================================================
        ...
        public class LineHandle
        {
            ...
            private TrendGraph m_Owner = null;

            // ===================================================================

            public LineHandle(ref Object line, TrendGraph owner)
            {
        ...
        public TrendGraph(Form parent, Rectangle rectPos)
        {
            parent.Controls.Add(this);
        ...
        {
            Pen gridPen = new Pen(m_GridColor, 2);
            Pen gridPen2 = new Pen(m_GridColor, 1);
            gridPen2.DashStyle = DashStyle.Dash  ;
            int cnt = 0;
            for (int n = Height - 1; n >= 0; n -= m_GridSize)
            {
                ...
                {
                    g.DrawLine(gridPen2, m_OffsetX, n, Width, n);
                }
                cnt++;
            }
            cnt = 0; 
            for (int n = m_OffsetX + m_MoveOffset; n < Width; n += m_GridSize)
            {
                ...
                {
                    g.DrawLine(gridPen2, n, 0, n, Height);
                }
                cnt++;
            }
