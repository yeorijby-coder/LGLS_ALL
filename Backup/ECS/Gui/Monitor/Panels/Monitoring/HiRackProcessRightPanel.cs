...
{
    public partial class HiRackProcessRIghtPanel : UserControl
    {
        ...
        public HiRackProcessRIghtPanel()
        {
            InitializeComponent();
            ...
            for (int i = 0; i < maxRow; i++)
            {
                for (int j = 0; j < maxColumn; j++)
                {
                    ...
                    if (i == 0)
                    {
                        ...
                        label.ForeColor = Color.Blue;
                        this.Controls.Add(label);
                        label.SetBounds(j * 14 + offsetLeft, ((maxRow-1)  * 14 + offsetTop), 16, 16);
                    }
                    ...
                    widget.SetBounds(j * 14 + offsetLeft, i * 14  , 16, 16);
