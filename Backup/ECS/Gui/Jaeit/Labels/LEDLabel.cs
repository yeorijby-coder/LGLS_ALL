...
namespace HECS.Gui.Jaeit.Labels
{
    /// <summary>
    /// A control that acts like a LED displayer
    /// </summary>
    public class LEDLabel : Control, ISupportInitialize
    {
        #region Nested Types
        /// <summary>
            ...
            Color colBorder, int nBorderWidth, bool bGradient, bool bDrawBorder)
        {
            ...
            if (bDrawBorder)
            {
                Pen pen = new Pen(m_colBorderColor);
        ...
        System.ComponentModel.DefaultValue(typeof(LEDLabel.Alignment), "Left")]
