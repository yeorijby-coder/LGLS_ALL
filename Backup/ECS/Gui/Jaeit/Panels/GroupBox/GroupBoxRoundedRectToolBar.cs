...
{
	/// <summary>
	/// Summary description for GroupBoxRoundedRectToolBarToolBar.
	/// </summary>
	public class GroupBoxRoundedRectToolBarToolBar : BaseContainer
	{
		...
		#endregion
		public GroupBoxRoundedRectToolBarToolBar():base(){}
