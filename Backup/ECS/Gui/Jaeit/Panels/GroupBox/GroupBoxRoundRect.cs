...
{
	/// <summary>
	/// Summary description for GroupBoxRoundedRect.
	/// </summary>
	public class GroupBoxRoundedRect : BaseContainer 
	{
		...
		#endregion
		public GroupBoxRoundedRect():base()
		{}
		...
		protected override void DrawBorder(System.Drawing.Graphics aoGraphics, System.Drawing.Rectangle aoRectangle)
		{
            ...
            if (oRcInterior.Width <= 0)
            {
                oRcInterior.Width = 2;
            }
            if (oRcInterior.Height <= 0)
            {
                oRcInterior.Height = 2;
            }
            LinearGradientBrush oGradientBrush = new LinearGradientBrush(oRcInterior, oContainer.BackgroundTopColor, oContainer.BackgroundBottomColor, LinearGradientMode.Vertical);
