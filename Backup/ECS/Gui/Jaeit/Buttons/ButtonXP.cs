...
namespace HECS.Gui.Jaeit.Buttons
{
    ...
    /// </summary>
    public class ButtonXP : System.Windows.Forms.Button
    {
        ...
        protected override void OnPaint(PaintEventArgs pea)
        {
            ...
            /*if (this.Focused)
            {
                ...
                rcFocus.Inflate(-3, -3);
                System.Windows.Forms.ButtonXPPainter.DrawFocusRectangle(pea.Graphics, rcFocus,
        ...
        private void OnDrawDisabled(Graphics g)
        {
            ...
            ButtonXPPainter.DrawRoundedRectangle(g, penBorder, rcBorder,
        ...
        private void OnDrawTextAndImage(Graphics g)
        {
            ...
            if (Enabled)
                ...
                brushText = new SolidBrush(ButtonXPPainter.DisabledForeColor);

            StringFormat sf = ButtonXPPainter.GetStringFormat(this.TextAlign);
        ...
        private void DrawBorder(Graphics g)
        {
            ...
            ButtonXPPainter.DrawRoundedRectangle(g, penBorder, this.BorderRectangle,
                sizeBorderPixelIndent);
            penBorder.Dispose();
        }
    ...
    //===========================================================================
    internal sealed class ButtonXPPainter
    {
        private ButtonXPPainter()
        {
        }
        ...
        {
            g.DrawRectangle(new Pen(ButtonXPPainter.BorderColor, 0), x, y,
                width, height);
        }
