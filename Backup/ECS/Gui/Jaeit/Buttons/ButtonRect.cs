...
namespace HECS.Gui.Jaeit.Buttons
{
	...
	/// </summary>
    [Designer(typeof(HECS.Gui.Jaeit.Buttons.ButtonRectDesigner))]
	public class ButtonRect : System.Windows.Forms.Control
	{
		...
		private void DrawBorder(Graphics g)
		{
			...
			if (m_MouseState == MouseState.Hoover || m_MouseState == MouseState.Pressed)
			{
				...
				case eButtonForm.Rectangle:
                    ...
                    g.DrawRectangle(SystemPens.GradientActiveCaption , 0, 0, Width - 1, Height - 1);
					break;
				case eButtonForm.Ellipse:
					g.FillEllipse(new SolidBrush(m_HighlightColor), 0, 0, Width - 1, Height - 1);
                    g.DrawEllipse(SystemPens.GradientActiveCaption, 0, 0, Width - 1, Height - 1);
					break;
				}
				return;
			}
	...
	public class ButtonRectDesigner : System.Windows.Forms.Design.ControlDesigner 
	{

        public ButtonRectDesigner()
		{
		}
