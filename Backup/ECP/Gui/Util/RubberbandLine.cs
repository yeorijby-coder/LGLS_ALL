...
{
    public enum PenStyles_Line_Line
    {
        PS_SOLID = 0
        ,
        PS_DASH = 1
    ...
    public class Rubberbandline
    {
        ...
        public IntPtr CreatePEN(
            PenStyles_Line_Line fnPenStyle,    // pen style
        ...
        public void XorLine(Graphics g, int X1, int Y1, int X2, int Y2)
        {
            BeginGDI(g);
            SetROP2(drawingMode.R2_XORPEN);
            IntPtr gdipen = CreatePEN(PenStyles_Line_Line.PS_DOT, 1, RGB(0, 0, 0));
            IntPtr oldpen;
