...
namespace EzControl.Driver.Fenet
{
    ...
    #region FenetMemory
    /// <summary>
    /// FenetMemory에 대한 요약 설명입니다.
    /// </summary>
    public class FenetMemory
    {
        ...
        public FenetMemory(enumDeviceType sDeviceType, short sStartAddress, short sEndAddress)
        {
    ...
    public sealed class FenetMemoryCollection : Dictionary<string, FenetMemory>
    {
    }
}
