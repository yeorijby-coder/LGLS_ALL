...
class CScPair;
class CScPairDlg : public CDialogEx
{
// Construction
public:
	CScPairDlg(CWnd* pParent = NULL);								// standard constructor
...
protected:
	...
	afx_msg void OnCheckSuspendStore();
	afx_msg void OnCheckSuspendRetrieve();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
public:
	BOOL m_bWriteLog;
	afx_msg void OnBnClickedCheckWriteLog();
};
