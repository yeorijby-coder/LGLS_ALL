...
class AFX_EXT_CLASS CFooButton : public CButton
{
	/////////////////////////////////////////////////////////////////////////////
	// Construction
public:
...
public:
	...
	void setGradientTopColor(COLORREF clrColor)
	{
		m_rgbTopGradient = clrColor;
	}

	void setGradientBottomColor(COLORREF clrColor)
	{
		m_rgbBottomGradient = clrColor;
	}

	void setGradientTopHotColor(COLORREF clrColor)
	{
		m_rgbTopGradientHot = clrColor;
	}

	void setGradientBottomHotColor(COLORREF clrColor)
	{
		m_rgbBottomGradientHot = clrColor;
	}
...
protected:
	...
	//! Button type.
	CFooButton::Type m_type;
	
	//! Text style.
	CFooButton::Text m_textStyle;
	
	//! Focus style.
	CFooButton::Focus m_focusStyle;
	...
	// Number of CFooButton instances.
	static int m_nRefs;
