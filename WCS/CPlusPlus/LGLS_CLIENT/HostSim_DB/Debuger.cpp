...
BOOL CDebuger::m_bAssert = TRUE;//::GetPrivateProfileInt(_T("COMMON"), _T("DebugerAssert"), FALSE, ECS_INI_FILE);
BOOL CDebuger::m_bTrace = TRUE;//::GetPrivateProfileInt(_T("COMMON"), _T("DebugerTrace"), FALSE, ECS_INI_FILE);
...
void CDebuger::Assert(int nIndex, int nSize, LPCSTR lpszLog, int nLine, LPCSTR lpszFile)
{
#ifdef _DEBUG
