...
public:
	CLogEvent() {}
	CLogEvent(BYTE nLogPos, BYTE nType, int nLuggNum, CString strContent, CString strProdID = _T(""), int nErrCode = 0);
	virtual ~CLogEvent() {}
...
public:
	...
	void ShowAlarm(int nLogPos, int nLuggNum, CString strContent, CString strProdID=_T(""));
