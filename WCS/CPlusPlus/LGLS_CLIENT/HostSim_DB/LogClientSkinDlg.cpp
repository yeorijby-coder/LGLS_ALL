...
CString CLogClientSkinDlg::GetQrySelect_Main(int nRowCheck,BOOL bSearch)
{
	...
	strSql += CRLF + _T("   AND TO_CHAR(WCL.INS_DT , 'YYYYMMDDHH24MISS') BETWEEN '") + strdtFrom + _T("' AND '") + strdtTo + _T("'");
