...
public:
	enum EN_COMMAND { enCmdWriteWord = 95, enCmdTrackDeadLockCheck = 96, enCmdTrackDeadLock = 97, enCmdTrackSuspend = 98, enCmdTrackWrite = 99 };
	enum { enSizeTrackDeadLockCheck = 2 };
	enum { enSizeTrackSuspend = 3 };
...
public:
	enum EN_COMMAND { enCmdDoorOpen, enCmdDoorClose, enCmdDoorStatus, enCmdTurnPermission, enCmdTurnPermissionRequest, enCmdFireAlarm };
	enum { enSizeDoor = 1 };
	enum { enSizeFireAlarm = 2 };
};
...
class CThsCmdMsg : public CCmdMsg
{
public:
	CThsCmdMsg() {}
	virtual ~CThsCmdMsg() {}
