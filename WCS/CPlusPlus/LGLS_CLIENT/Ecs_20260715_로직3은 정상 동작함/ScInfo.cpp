...
COLORREF CScInfo::GetRailColor()
{
	...
	BOOL bCarry = ( (m_pSC_DATA->V_ITN_LUGG_FK1 != _T("0") && m_pSC_DATA->V_ITN_LUGG_FK1 != _T("0000") && m_pSC_DATA->V_ITN_LUGG_FK1 != _T(""))
	             || (m_pSC_DATA->V_ITN_LUGG_FK2 != _T("0") && m_pSC_DATA->V_ITN_LUGG_FK2 != _T("0000") && m_pSC_DATA->V_ITN_LUGG_FK2 != _T("")) );
	return bCarry ? BLUE : BLACK;
	//RAIL 색상
}
...
COLORREF CScInfo::GetRailColor(CSC_DATA* pSC_DATA)
{
	...
	BOOL bCarry = ( (pSC_DATA->V_ITN_LUGG_FK1 != _T("0") && pSC_DATA->V_ITN_LUGG_FK1 != _T("0000") && pSC_DATA->V_ITN_LUGG_FK1 != _T(""))
	             || (pSC_DATA->V_ITN_LUGG_FK2 != _T("0") && pSC_DATA->V_ITN_LUGG_FK2 != _T("0000") && pSC_DATA->V_ITN_LUGG_FK2 != _T("")) );
	return bCarry ? BLUE : BLACK;
}
