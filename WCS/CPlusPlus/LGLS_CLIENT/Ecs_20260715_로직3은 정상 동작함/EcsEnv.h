...
#define MDLN						_T("ECS ")
#define VER_MON						_T("1.0.0 ")
#define MON_NAME					_T("SDI-KOR STKE1S MONITERING")
...
#define WM_USER_CONTROL_CLICK			(WM_USER + 10)
#define WM_USER_ALARM_NOTIFY			(WM_USER + 11)
#define WM_USER_REFRESH_NOTIFY			(WM_USER + 12)
#define WM_USER_MESSAGE_NOTIFY			(WM_USER + 13)
#define WM_USER_LANG_NOTIFY				(WM_USER + 14)
#define WM_USER_REFRESH_LAYOUT			(WM_USER + 15)
#define WM_USER_REFRESH_DIALOG		    (WM_USER + 16)

#define WM_USER_REFRESH_COLLECT_CELLINFO (WM_USER + 17)
#define WM_USER_REFRESH_COLLECT_JOBINFO (WM_USER + 18)

#define WM_USER_DLG_REFRESH_NOTIFY		(WM_USER + 19)

#define WM_USER_SELECETED_CHANGED		(WM_USER + 31)
#define WM_USER_ALARMSTATE_CHANGED		(WM_USER + 32)
#define WM_USER_CONTROLSTATE_CHANGED	(WM_USER + 33)
#define WM_USER_SCSTATE_CHANGED			(WM_USER + 34)
#define WM_USER_TOTALJOB_CHANGED		(WM_USER + 35)
#define WM_USER_MASTERPLC_CHANGED		(WM_USER + 36)
#define WM_USER_TSCSTATE_CHANGED		(WM_USER + 37)

#define WM_USER_DIALOG_MESSAGE_REFRESH	(WM_USER + 38)

#define WM_USER_FIREDIALOG_MESSAGE_STOP (WM_USER + 39)
