...
BOOL CJobOfflineDlg::OnInitDialog() 
{
	...
	int w = 32, h = 32;
	INIT_BUTTON(m_btnCreate, IDI_RUN, w, h, "반자동작업 생성");
	INIT_BUTTON(m_btnOK, IDI_EXIT, w, h, "창닫기");
	...
	m_tabJobType.InsertItem(0, _T("입고작업"), 0);
	m_tabJobType.InsertItem(1, _T("출고작업"), 1);
	m_tabJobType.InsertItem(2, _T("랙간이동"), 2);
	m_tabJobType.InsertItem(3, _T("이동작업"), 3);
//	m_tabJobType.InsertItem(4, _T("창고간이동"), 4);
