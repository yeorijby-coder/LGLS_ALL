...
CEquipment::CEquipment(CEcsDoc* pDoc, int nIndex, int nNumber, LPCTSTR lpszDevice)
{
	...
	for (int i = 0 ; i < PLC_CONN_PORT_CNT ; i++)
	{
		...
		//m_hEventArray[i][enEventSend1] = ::CreateEvent(NULL, FALSE, FALSE, NULL);
		//m_hEventArray[i][enEventSend2] = ::CreateEvent(NULL, FALSE, FALSE, NULL);
		//m_hEventArray[i][enEventSend3] = ::CreateEvent(NULL, FALSE, FALSE, NULL);
		//m_hEventArray[i][enEventSend4] = ::CreateEvent(NULL, FALSE, FALSE, NULL);
		//m_hEventArray[i][enEventSend5] = ::CreateEvent(NULL, FALSE, FALSE, NULL);
		//m_hEventArray[i][enEventSend6] = ::CreateEvent(NULL, FALSE, FALSE, NULL);
		//m_hEventArray[i][enEventSend7] = ::CreateEvent(NULL, FALSE, FALSE, NULL);
		//m_hEventArray[i][enEventSend8] = ::CreateEvent(NULL, FALSE, FALSE, NULL);
		//m_hEventArray[i][enEventSend9] = ::CreateEvent(NULL, FALSE, FALSE, NULL);
		//m_hEventArray[i][enEventSend10] = ::CreateEvent(NULL, FALSE, FALSE, NULL);
		//m_hEventArray[i][enEventSend11] = ::CreateEvent(NULL, FALSE, FALSE, NULL);
		//m_hEventArray[i][enEventSend12] = ::CreateEvent(NULL, FALSE, FALSE, NULL);
		//m_hEventArray[i][enEventSend13] = ::CreateEvent(NULL, FALSE, FALSE, NULL);
		//m_hEventArray[i][enEventSend14] = ::CreateEvent(NULL, FALSE, FALSE, NULL);
		//m_hEventArray[i][enEventSend15] = ::CreateEvent(NULL, FALSE, FALSE, NULL);
		//m_hEventArray[i][enEventSend16] = ::CreateEvent(NULL, FALSE, FALSE, NULL);
		//m_hEventArray[i][enEventSend17] = ::CreateEvent(NULL, FALSE, FALSE, NULL);
		//m_hEventArray[i][enEventSend18] = ::CreateEvent(NULL, FALSE, FALSE, NULL);
...
CEquipment::~CEquipment()
{
	...
	for (int i = 0 ; i < PLC_CONN_PORT_CNT ; i++)
	{
		...
		//::CloseHandle(m_hEventArray[i][enEventSend1]);
		//::CloseHandle(m_hEventArray[i][enEventSend2]);
		//::CloseHandle(m_hEventArray[i][enEventSend3]);
		//::CloseHandle(m_hEventArray[i][enEventSend4]);
		//::CloseHandle(m_hEventArray[i][enEventSend5]);
		//::CloseHandle(m_hEventArray[i][enEventSend6]);
		//::CloseHandle(m_hEventArray[i][enEventSend7]);
		//::CloseHandle(m_hEventArray[i][enEventSend8]);
		//::CloseHandle(m_hEventArray[i][enEventSend9]);
		//::CloseHandle(m_hEventArray[i][enEventSend10]);
		//::CloseHandle(m_hEventArray[i][enEventSend11]);
		//::CloseHandle(m_hEventArray[i][enEventSend12]);
		//::CloseHandle(m_hEventArray[i][enEventSend13]);
		//::CloseHandle(m_hEventArray[i][enEventSend14]);
		//::CloseHandle(m_hEventArray[i][enEventSend15]);
		//::CloseHandle(m_hEventArray[i][enEventSend16]);
		//::CloseHandle(m_hEventArray[i][enEventSend17]);
		//::CloseHandle(m_hEventArray[i][enEventSend18]);
...
void CEquipment::UpdateCommStatus(int nStatus, int nNum)
{
	...
	if (m_pDoc && m_pDoc->m_hWndView)
		::PostMessage(m_pDoc->m_hWndView, uMsg, ((m_nNumber-1)*16)+nNum, nStatus);
}
...
BOOL CEquipment::ConnectServer(int nIndex)
{
	...
	m_pSocket[nIndex]->Connect(m_port.m_strIP, m_port.m_nPort[0]);
...
//		if (nEquipKind == CEquipment::enBCR)
//		{
//			if (pEquipment->m_enKind == nEquipKind && ((CBcr*)pEquipment)->GetInfoIndex(nEquipNum) >= 0)
//				return pEquipment;
//		}
//		else
//		{
