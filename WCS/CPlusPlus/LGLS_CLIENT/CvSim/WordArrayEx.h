// WordArrayEx.h: interface for the CByteArrayEx class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_WORDARRAYEX_H__5E536D86_43A8_4AD5_B4AE_AC16115681AB__INCLUDED_)
#define AFX_WORDARRAYEX_H__5E536D86_43A8_4AD5_B4AE_AC16115681AB__INCLUDED_
...
public:
	CWordArrayEx();
	CWordArrayEx(int nStartWordAddr, int nTotalWordSize);
	virtual ~CWordArrayEx();
...
public:
	...
	void SetByte(int nWordAddr, EN_BYTE enByte, WORD ucByte);
	void SetNibble(int nWordAddr, EN_NIBBLE enNibble, WORD ucNibble);
	void SetBit(int nWordAddr, EN_BIT enBit, BOOL bBit);
	void InverseBit(int nWordAddr, EN_BIT enBit);
...
#endif // !defined(AFX_WORDARRAYEX_H__5E536D86_43A8_4AD5_B4AE_AC16115681AB__INCLUDED_)
