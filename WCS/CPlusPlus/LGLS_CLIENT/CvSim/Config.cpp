...
//		DEBUGER_ASSERT_VALID(pEquipment != NULL);
		...
		//port.m_nPort[0]		 = ::GetPrivateProfileInt(port.m_strDevice, _T("Port1"), 0, ECS_INI_FILE);
		//port.m_nPort[1]		 = ::GetPrivateProfileInt(port.m_strDevice, _T("Port2"), 0, ECS_INI_FILE);
		//port.m_nPort[2]		 = ::GetPrivateProfileInt(port.m_strDevice, _T("Port3"), 0, ECS_INI_FILE);
		//port.m_nPort[3]		 = ::GetPrivateProfileInt(port.m_strDevice, _T("Port4"), 0, ECS_INI_FILE);
		//port.m_nPort[4]		 = ::GetPrivateProfileInt(port.m_strDevice, _T("Port5"), 0, ECS_INI_FILE);
		//port.m_nPort[5]		 = ::GetPrivateProfileInt(port.m_strDevice, _T("Port6"), 0, ECS_INI_FILE);
		//port.m_nPort[6]		 = ::GetPrivateProfileInt(port.m_strDevice, _T("Port7"), 0, ECS_INI_FILE);
		//port.m_nPort[7]		 = ::GetPrivateProfileInt(port.m_strDevice, _T("Port8"), 0, ECS_INI_FILE);
		//port.m_nPort[8]		 = ::GetPrivateProfileInt(port.m_strDevice, _T("Port9"), 0, ECS_INI_FILE);
		//port.m_nPort[9]		 = ::GetPrivateProfileInt(port.m_strDevice, _T("Port10"), 0, ECS_INI_FILE);
		//port.m_nPort[10]	 = ::GetPrivateProfileInt(port.m_strDevice, _T("Port11"), 0, ECS_INI_FILE);
		//port.m_nPort[11]	 = ::GetPrivateProfileInt(port.m_strDevice, _T("Port12"), 0, ECS_INI_FILE);
		//port.m_nPort[12]	 = ::GetPrivateProfileInt(port.m_strDevice, _T("Port13"), 0, ECS_INI_FILE);
		//port.m_nPort[13]	 = ::GetPrivateProfileInt(port.m_strDevice, _T("Port14"), 0, ECS_INI_FILE);
		//port.m_nPort[14]	 = ::GetPrivateProfileInt(port.m_strDevice, _T("Port15"), 0, ECS_INI_FILE);
		//port.m_nPort[15]	 = ::GetPrivateProfileInt(port.m_strDevice, _T("Port16"), 0, ECS_INI_FILE);
		//port.m_nPort[16]	 = ::GetPrivateProfileInt(port.m_strDevice, _T("Port17"), 0, ECS_INI_FILE);
		//port.m_nPort[17]	 = ::GetPrivateProfileInt(port.m_strDevice, _T("Port18"), 0, ECS_INI_FILE);
		...
		//if (pEquipment->m_pSocket1)
		//	pEquipment->m_pSocket1->m_bWriteLog = port.m_bWriteLog;
		//if (pEquipment->m_pSocket2)
		//	pEquipment->m_pSocket2->m_bWriteLog = port.m_bWriteLog;
		//if (pEquipment->m_pSocket3)
		//	pEquipment->m_pSocket3->m_bWriteLog = port.m_bWriteLog;
		//if (pEquipment->m_pSocket4)
		//	pEquipment->m_pSocket4->m_bWriteLog = port.m_bWriteLog;
		//if (pEquipment->m_pSocket5)
		//	pEquipment->m_pSocket5->m_bWriteLog = port.m_bWriteLog;
		//if (pEquipment->m_pSocket6)
		//	pEquipment->m_pSocket6->m_bWriteLog = port.m_bWriteLog;
		//if (pEquipment->m_pSocket7)
		//	pEquipment->m_pSocket7->m_bWriteLog = port.m_bWriteLog;
		//if (pEquipment->m_pSocket8)
		//	pEquipment->m_pSocket8->m_bWriteLog = port.m_bWriteLog;
		//if (pEquipment->m_pSocket9)
		//	pEquipment->m_pSocket9->m_bWriteLog = port.m_bWriteLog;
		//if (pEquipment->m_pSocket10)
		//	pEquipment->m_pSocket10->m_bWriteLog = port.m_bWriteLog;
		//if (pEquipment->m_pSocket11)
		//	pEquipment->m_pSocket11->m_bWriteLog = port.m_bWriteLog;
		//if (pEquipment->m_pSocket12)
		//	pEquipment->m_pSocket12->m_bWriteLog = port.m_bWriteLog;
		//if (pEquipment->m_pSocket13)
		//	pEquipment->m_pSocket13->m_bWriteLog = port.m_bWriteLog;
		//if (pEquipment->m_pSocket14)
		//	pEquipment->m_pSocket14->m_bWriteLog = port.m_bWriteLog;
		//if (pEquipment->m_pSocket15)
		//	pEquipment->m_pSocket15->m_bWriteLog = port.m_bWriteLog;
		//if (pEquipment->m_pSocket16)
		//	pEquipment->m_pSocket16->m_bWriteLog = port.m_bWriteLog;
		//if (pEquipment->m_pSocket17)
		//	pEquipment->m_pSocket17->m_bWriteLog = port.m_bWriteLog;
		//if (pEquipment->m_pSocket18)
		//	pEquipment->m_pSocket18->m_bWriteLog = port.m_bWriteLog;
//		if (pEquipment->m_enKind == CEquipment::enCV)
//		{
//			pEquipment->m_nStTrNum = ::GetPrivateProfileInt(port.m_strDevice.Left(6), _T("StTrNum"), 1, ECS_INI_FILE);
//			int index = _ttoi(port.m_strDevice.Mid(4, 2));
