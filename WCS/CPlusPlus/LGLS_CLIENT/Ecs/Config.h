...
public: 
	...
	// [LGLS 2026-07-19] 반자동 작업 색상 (자동의 다크 변형이 기본값)
	COLORREF m_clrUSER_COLOR_SEMI_STO;
	COLORREF m_clrUSER_COLOR_SEMI_RET;
	COLORREF m_clrUSER_COLOR_SEMI_MOVE;
	...
	COLORREF m_clrUSER_COLOR_TRACKING;	// [LGLS 2026-09-12] 화물 없이 작업번호(트래킹)만 남은 트랙 (범례 20 "작업번호 있음")
