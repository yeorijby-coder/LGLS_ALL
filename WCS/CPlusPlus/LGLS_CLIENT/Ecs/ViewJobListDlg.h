...
public:
	CPtrArray m_arLglsCtrl;		// [LGLS 2026-08-01] 런타임 생성 조회칸(적재 용기/제품 정보)
...
public:
	...
	CSkinButton m_btnJobAllComplete;	// [LGLS 2026-08-24] 일괄 완료
...
//	afx_msg void OnBnClickedJobUpdate();
	...
	void JobCompleteAll();					// [LGLS 2026-08-24] 잔여 스텝 일괄 완료
