...
//-------------------------------------------------------enum match
//이미지 관련
// [LGLS 2026-09-12] 아이콘을 rc_resource\ico 로 옮겼다(사용자 지시) - 종전 ecs_resource 폴더는 없앴다.
#define  IDX_ICON_CV_ON _T(".\\rc_resource\\ico\\on.ico")
#define  IDX_ICON_CV_OFF _T(".\\rc_resource\\ico\\off.ico")
#define  IDX_ICON_WRITE _T(".\\rc_resource\\ico\\write.ico")
#define  IDX_ICON_COPY _T(".\\rc_resource\\ico\\copy.ico")
#define  IDX_ICON_CUT _T(".\\rc_resource\\ico\\cut.ico")
#define  IDX_ICON_DELETE _T(".\\rc_resource\\ico\\delete.ico")
#define  IDX_ICON_PASTE _T(".\\rc_resource\\ico\\paste.ico")
#define  IDX_ICON_ACTIVE _T(".\\rc_resource\\ico\\active.ico")
#define  IDX_ICON_CALL_TO_HOME _T(".\\rc_resource\\ico\\calltohome.ico")
#define  IDX_ICON_COMPLETE _T(".\\rc_resource\\ico\\complete.ico")
#define  IDX_ICON_EMGSTOP _T(".\\rc_resource\\ico\\emgstop.ico")
#define  IDX_ICON_ERROR_RESET _T(".\\rc_resource\\ico\\errreset.ico")
#define  IDX_ICON_JOB_DELETE _T(".\\rc_resource\\ico\\jobdelete.ico")
#define  IDX_ICON_MANUAL _T(".\\rc_resource\\ico\\manual.ico")
#define  IDX_ICON_RESET _T(".\\rc_resource\\ico\\reset.ico")
#define  IDX_ICON_STOP _T(".\\rc_resource\\ico\\stop.ico")
#define  IDX_ICON_SAVE _T(".\\rc_resource\\ico\\save.ico")
#define  IDX_ICON_LEFT _T(".\\rc_resource\\ico\\left.ico")
#define  IDX_ICON_RIGHT _T(".\\rc_resource\\ico\\right.ico")
#define  IDX_ICON_SEARCH _T(".\\rc_resource\\ico\\search.ico")	
#define  IDX_ICON_SEMIJOB _T(".\\rc_resource\\ico\\semijob.ico")
#define  IDX_ICON_MENU_EQP_SUSPEND _T(".\\rc_resource\\ico\\eqpsuspend.ico")
#define  IDX_ICON_RETIREVE _T(".\\rc_resource\\ico\\retireve.ico")
#define  IDX_ICON_CLOSE _T(".\\rc_resource\\ico\\exit.ico")
#define  IDX_ICON_READ _T(".\\rc_resource\\ico\\read.ico")
#define  IDX_ICON_REPORT _T(".\\rc_resource\\ico\\report.ico")
#define  IDX_ICON_REQUESTRESET _T(".\\rc_resource\\ico\\requestreset.ico")
