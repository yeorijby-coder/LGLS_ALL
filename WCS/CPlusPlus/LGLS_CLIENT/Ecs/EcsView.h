...
public:
	...
	//   대상 : [ETC] ViewRetCnt, [MENU] ZOOM_BTN·UI_TRACE·LOADBIT_GATE·VEH_DOWN_COLOR, [Title] 3키, [RibbonMenu] ToolTip
...
protected:
	...
	afx_msg void OnLButtonDblClk(UINT nFlags, CPoint point);	// [LGLS 2026-09-15] 방향 칸 더블클릭 = 방향 전환
	BOOL DirectionToggleByDblClk(CPoint point);
