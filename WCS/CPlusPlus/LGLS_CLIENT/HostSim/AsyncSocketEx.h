...
#define	MSG_LENGTH_COMPLETE_DATA		13
#define	MSG_LENGTH_COMPLETE_MSG			(MSG_LENGTH_HEADER + MSG_LENGTH_COMPLETE_DATA)
#define	MSG_LENGTH_ARRIVAL_DATA			10		// 12
#define	MSG_LENGTH_ARRIVAL_MSG			(MSG_LENGTH_HEADER + MSG_LENGTH_ARRIVAL_DATA)
#define	MSG_LENGTH_REQSTORE_DATA		28
#define	MSG_LENGTH_REQSTORE_MSG			(MSG_LENGTH_HEADER + MSG_LENGTH_REQSTORE_DATA)
#define	MSG_LENGTH_REQRETRIEVE_DATA		10
#define	MSG_LENGTH_REQRETRIEVE_MSG		(MSG_LENGTH_HEADER + MSG_LENGTH_REQRETRIEVE_DATA)
#define	MSG_LENGTH_ERROR_DATA			44		// 23
#define	MSG_LENGTH_ERROR_MSG			(MSG_LENGTH_HEADER + MSG_LENGTH_ERROR_DATA)
#define	MSG_LENGTH_BARCODE_DATA			38		// 27
...
#define	MSG_LENGTH_STATUS_DATA			83		// 82		// 35
...
public:
	...
	void TokenRxFrame(CString& strRecv, TCHAR chSTX, TCHAR chETX, BOOL bIMS = FALSE);
