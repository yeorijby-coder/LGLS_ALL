...
CMelsecSerialSk::CMelsecSerialSk(CEquipment* pEquipment) : CInterfaceSk(pEquipment)
{
...
BOOL CMelsecSerialSk::ReadWord(CByteArray& arrRxData, int nStartWord, int nWordLen, BYTE bDeviceCode)
{
...
BOOL CMelsecSerialSk::WriteWord(CByteArray& arrTxData, int nStartWord, int nWordLen, BYTE bDeviceCode)
{
