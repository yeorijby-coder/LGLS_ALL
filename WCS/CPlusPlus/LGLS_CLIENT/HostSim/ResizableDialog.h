...
class AFX_EXT_CLASS CResizableDialog : public CDialog
{
...
private:
	...
	public:
		Layout()
			...
			tl_type(0, 0), tl_margin(0, 0), br_type(0, 0), br_margin(0, 0)
		{
		};

		Layout(HWND hw, SIZE tl_t, SIZE tl_m, SIZE br_t, SIZE br_m, BOOL hscroll, BOOL refresh)
		{
			hwnd = hw;
