...
BOOL CWarningDlg::OnInitDialog() 
{
	...
	m_ctlReport.InsertColumn(_T("작업번호"), _T("CARRIERID"), _T("구분"), _T("LOGGING 내용"), _T("ETX"));
...
{
	m_btnShow.setType (CFooButton::Type::checkBox);
	m_btnShow.check (!m_bShow);
	m_btnShow.setTextColor(RGB(51, 102, 255));

	m_btnFirst.setGradient (true);
	m_btnFirst.setType (CFooButton::Type::hotPushButton);

	m_btnLast.setGradient (true);
	m_btnLast.setType (CFooButton::Type::hotPushButton);

	m_btnNext.setGradient (true);
	m_btnNext.setType (CFooButton::Type::hotPushButton);

	m_btnPrev.setGradient (true);
	m_btnPrev.setType (CFooButton::Type::hotPushButton);

	m_btnDelete.setGradient (true);
	m_btnDelete.setType (CFooButton::Type::hotPushButton);

	m_btnExit.setGradient (true);
	m_btnExit.setGradientBottomColor(RGB(212, 124, 168));
	m_btnExit.setType (CFooButton::Type::hotPushButton);
}
