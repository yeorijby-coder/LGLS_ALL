// MelsecEthernetThreadSk.cpp: implementation of the CMelsecEthernetSk class.
//
//////////////////////////////////////////////////////////////////////
...
IMPLEMENT_DYNAMIC(CMelsecEthernetThreadSk, CInterfaceThreadSk)

CMelsecEthernetThreadSk::CMelsecEthernetThreadSk(CEquipment* pEquipment) : CInterfaceThreadSk(pEquipment)
{
	m_bReceiving = FALSE;

}

CMelsecEthernetThreadSk::~CMelsecEthernetThreadSk()
{
	m_bReceiving = FALSE;

}
/*
BOOL CMelsecEthernetThreadSk::Read(int nUnitType, BYTE *pRxBuff, BYTE DeviceCode, int nStartAddr, WORD wReadLen, BOOL bIsAscii)
{
...
BOOL CMelsecEthernetThreadSk::Write(int nUnitType, BYTE *pTxBuff, BYTE DeviceCode, int nStartAddr, WORD wWriteLen, BOOL bIsAscii)
{
...
*/
BOOL CMelsecEthernetThreadSk::ReadWord(CByteArray& arrRxData, int nStartWord, int nWordLen, BYTE bDeviceCode)
{
...
BOOL CMelsecEthernetThreadSk::WriteWord(CByteArray& arrTxData, int nStartWord, int nWordLen, BYTE bDeviceCode)
{
...
BOOL CMelsecEthernetThreadSk::Read(int nUnitType, BYTE *pRxBuff, BYTE DeviceCode, int nStartAddr, WORD wReadLen)
{
	m_strErrMsg = "";
...
BOOL CMelsecEthernetThreadSk::Write(int nUnitType, BYTE *pTxBuff, BYTE DeviceCode, int nStartAddr, WORD wWriteLen)
{
	m_strErrMsg = "";
...
BOOL CMelsecEthernetThreadSk::RecvReadAck(int nUnitType, BYTE *pRxBuff, WORD wReadLen)
{
	int nRecvLen = 0;
	BYTE RxBuff[8192];
...
BOOL CMelsecEthernetThreadSk::RecvWriteAck()
{
	BYTE RxBuff[2048];
	int nRecvLen;
...
int CMelsecEthernetThreadSk::RecvFrame(BYTE *pRxBuff)
{
...
WORD CMelsecEthernetThreadSk::SwapToWord(BYTE *pSrc)
{
	return (WORD)(pSrc[1] << 8) | pSrc[0];
}

DWORD CMelsecEthernetThreadSk::SwapToDWord(BYTE *pSrc)
{
	return (DWORD)(pSrc[3] << 24) | (pSrc[2] << 16) | (pSrc[1] << 8) | pSrc[0];
}


int CMelsecEthernetThreadSk::GetDataLength(int nUnitType, WORD wLen)
{
