...
BACKUP DATABASE LGLS_MCS_IO_DEPLOY TO DISK = N'D:\project\LGLS\Renewal\DB_BACKUP\LGLS_MCS_IO_20260907_clean.bak' WITH INIT, COPY_ONLY;
GO
USE master;
ALTER DATABASE LGLS_MCS_IO_DEPLOY SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
DROP DATABASE LGLS_MCS_IO_DEPLOY;
